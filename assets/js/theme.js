...
// Set theme immediately on script load to avoid flicker
(function() {
...
// Only allow 'light' and 'dark' theme settings. Default to 'light'.
...
// Only allow 'light' and 'dark' as computed theme.
